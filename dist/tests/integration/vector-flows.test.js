...
describe("Vector Database Integration Tests", () => {
    ...
    describe("Text Embedding Operations", () => {
        test("should generate embeddings for single text", () => __awaiter(void 0, void 0, void 0, function* () {
            const flow = {
                ...
                nodes: [
                    {
                        id: "create_embedding",
                        type: types_1.NodeType.TEXT_EMBEDDING,
            ...
            const result = yield executor.executeFlow(flow, {
                input_text: process.env.TEST_SAMPLE_TEXT ||
        ...
        test("should generate embeddings for multiple texts", () => __awaiter(void 0, void 0, void 0, function* () {
            const flow = {
        ...
        test("should handle embeddings with metadata", () => __awaiter(void 0, void 0, void 0, function* () {
            const flow = {
            ...
            result.outputs.embedding_result.forEach((embedding) => {
                expect(embedding).toHaveProperty("id");
                expect(embedding).toHaveProperty("values");
    ...
    describe("Vector Database Operations", () => {
        ...
        test("should insert vectors into database", () => __awaiter(void 0, void 0, void 0, function* () {
            const flow = {
                ...
                nodes: [
                    ...
                    {
                        id: "insert_vector",
                        type: types_1.NodeType.VECTOR_INSERT,
                        name: "Insert Vector",
                        config: {
                            provider: "pinecone",
                            index_name: process.env.TEST_INDEX_NAME || "openflow-test-index",
            ...
            const result = yield executor.executeFlow(flow, {
                text_to_embed: "This is a test document for vector insertion and retrieval.",
            });
            console.log("res", result);
            expect(result.success).toBe(true);
        }));
        test("should search vectors in database", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const searchFlow = {
                ...
                nodes: [
                    ...
                    {
                        id: "search_vectors",
                        type: types_1.NodeType.VECTOR_SEARCH,
            ...
            const searchResult = yield executor.executeFlow(searchFlow, {
    ...
    describe("Complete Embed and Store Flow", () => {
        const testNamespace = process.env.TEST_NAMESPACE || "test-namespace";
        test("should execute complete embed and store workflow", () => __awaiter(void 0, void 0, void 0, function* () {
            const flow = {
    ...
    describe("Vector Operations Error Handling", () => {
        test("should handle embedding provider errors", () => __awaiter(void 0, void 0, void 0, function* () {
            const flow = {
        ...
        test("should handle vector database connection errors", () => __awaiter(void 0, void 0, void 0, function* () {
            const configWithInvalidKey = Object.assign(Object.assign({}, config), { providers: Object.assign(Object.assign({}, config.providers), { vectorDB: {
                        pinecone: {
                            provider: "pinecone",
                            apiKey: "invalid-key",
            ...
            const executorWithInvalidConfig = new FlowExecutor_1.FlowExecutor(configWithInvalidKey);
            const flow = {
            ...
            yield expect(executorWithInvalidConfig.executeFlow(flow)).rejects.toThrow();
        }));
    });
});
