...
describe("MCP Integration Tests", () => {
    ...
    describe("DeepWiki MCP Integration", () => {
        test("should execute research flow with DeepWiki MCP", () => __awaiter(void 0, void 0, void 0, function* () {
            if (!process.env.GROK_API_KEY) {
                ...
                nodes: [
                    {
                        ...
                        config: {
                            ...
                            mcp_servers: [
                                {
                                    name: "deepwiki",
                                    url: process.env.MCP_DEEPWIKI_URL ||
    ...
    describe("Semgrep MCP Integration", () => {
        test("should execute code analysis flow with Semgrep MCP", () => __awaiter(void 0, void 0, void 0, function* () {
            if (!process.env.GROK_API_KEY) {
                pending("No Grok API key provided");
                return;
            }
                ...
                nodes: [
                    {
                        ...
                        config: {
                            ...
                            mcp_servers: [
                                {
                                    name: "semgrep",
                                    url: process.env.MCP_SEMGREP_URL || "https://mcp.semgrep.ai/mcp",
    ...
    describe("CoinGecko MCP Integration", () => {
        test("should execute cryptocurrency data flow with CoinGecko MCP", () => __awaiter(void 0, void 0, void 0, function* () {
            if (!process.env.GROK_API_KEY) {
                pending("No Grok API key provided");
                return;
            }
                ...
                nodes: [
                    {
                        ...
                        config: {
                            ...
                            mcp_servers: [
                                {
                                    name: "coingecko",
                                    url: process.env.MCP_COINGECKO_URL ||
    ...
    describe("MCP Error Handling", () => {
        test("should handle MCP server timeout gracefully", () => __awaiter(void 0, void 0, void 0, function* () {
            if (!process.env.GROK_API_KEY) {
                pending("No Grok API key provided");
                return;
            }
        ...
        test("should handle MCP authentication errors", () => __awaiter(void 0, void 0, void 0, function* () {
            if (!process.env.GROK_API_KEY) {
                pending("No Grok API key provided");
                return;
            }
    ...
    describe("Multiple MCP Servers", () => {
        test("should handle multiple MCP servers in one flow", () => __awaiter(void 0, void 0, void 0, function* () {
            if (!process.env.GROK_API_KEY) {
                pending("No Grok API key provided");
                return;
            }
